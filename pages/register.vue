  ...
  <div class="font-sans bg-white overflow-x-hidden">
    <header class="flex flex-col md:flex-row justify-between items-center p-4 bg-white relative">
      ...
      <div class="header-right flex items-center">
        ...
        <NuxtLink to="/login"><button class="btn-masuk bg-teal-600 text-white hover:bg-teal-400 transition-colors duration-400 font-bold py-2 px-3 rounded">Masuk</button></NuxtLink>
      </div>
    </header>
    ...
    <div class="max-w-md mx-auto mt-1 p-4 bg-white rounded-lg text-blue-900">
      <h2 class="text-2xl font-semibold mb-2">Daftar!<br>Silakan masukkan username, email, dan password anda untuk membuat akun.</h2>
      <form @submit.prevent="handleRegister">
        ...
        <button type="submit" class="w-full bg-teal-600 text-white py-2 px-4 rounded-md hover:bg-teal-400 transition duration-300 font-bold">Daftar</button>
      </form>
