    ...
    <main>
      ...
      <section class="best-offers p-4 bg-white mt-4">
        <div class="section-header flex justify-between items-center mb-4">
          <h2 class="text-md font-bold">Best Offers</h2>
        ...
        <div class="event-list grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 justify-center" style="scrollbar-width: none; -ms-overflow-style: none">
          <nuxt-link to="/event" class="event-card flex-none w-60">
          ...
          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/e.jpg" alt="MaKrab KAMPUS SUCI" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">MaKrab KAMPUS SUCI</h3>
                <b class="text-black py-1 px-2 rounded">IDR 249K</b>
          </nuxt-link>
        </div>
        <br/>

        <div class="section-header flex justify-between items-center mb-4">
          <h2 class="text-md font-bold">Jalan Jalan Untuk Satu Circle Paling Seru</h2>
          <nuxt-link to="/event" class="view-all bg-teal-100 text-green-700 py-2 px-4 rounded-full hover:bg-teal-200 transition-colors duration-400 font-bold">Lihat Semua</nuxt-link>
        </div>

        <div class="event-list grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 justify-center" style="scrollbar-width: none; -ms-overflow-style: none">
          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/a.jpg" alt="JakCloth Summer Fest 2024" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">JakCloth Summer Fest 2024</h3>
               <b class="text-black py-1 px-2 rounded">Dari IDR 35K</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/b.jpg" alt="Djakarta Warehouse Project 2024" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">Djakarta Warehouse Project 2024</h3>
                <b class="text-black py-1 px-2 rounded">Dari IDR 980K</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/c.jpg" alt="Anfield: The Road to Istanbul" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">Anfield: The Road to Istanbul</h3>
                <b class="text-black py-1 px-2 rounded">IDR 150K</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/d.jpg" alt="Campus Eleven Experience Tour 2024" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">Campus Eleven Experience Tour 2024</h3>
                <b class="text-black py-1 px-2 rounded">IDR 250K</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/e.jpg" alt="NIGHTMARE IN BALI" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">NIGHTMARE IN BALI</h3>
                <b class="text-black py-1 px-2 rounded">IDR 150K</b>
          </nuxt-link>
        </div>
        <br />
        ...
        <div class="section-header flex justify-between items-center mb-4">
          <h2 class="text-md font-bold">Attractions</h2>
            <nuxt-link to="/event" class="view-all bg-teal-100 text-green-700 py-2 px-4 rounded-full hover:bg-teal-200 transition-colors duration-400 font-bold">Lihat Semua</nuxt-link>
        </div>
        
        <div class="event-list grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 justify-center" style="scrollbar-width: none; -ms-overflow-style: none">
          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/a.jpg" alt="Desa Wisata Kerinci Bupati" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">Dept Live in Jakarta 2024</h3>
                <p class="text-black py-1 px-2 rounded font-bold">Dari IDR 840K</p>
                  <b class="bg-red-500 text-white py-1 px-2 rounded-full">Diskon s/d 50%</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/b.jpg" alt="Cultural Heritage of Tana Toraja" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">SOUNDSHOCK</h3>
                <P class="text-black py-1 px-2 rounded font-bold">Dari IDR 149K</P>
                  <b class="bg-red-500 text-white py-1 px-2 rounded-full">Diskon s/d 50%</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/c.jpg" alt="Ubud Monkey Forest Tour" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">BANG YEDAM 1ST FAN MEETING IN JAKARTA</h3>
          ...
          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/d.jpg" alt="Komodo Island Adventure" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">The Papandayan Jazz Fest 2024</h3>
                <p class="text-black py-1 px-2 rounded font-bold">Dari IDR 195K</p>
                  <b class="bg-red-500 text-white py-1 px-2 rounded-full">Diskon s/d 50%</b>
          </nuxt-link>

          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/e.jpg" alt="Borobudur Temple Exploration" class="rounded-lg" />
              <h3 class="text-lg mt-2 px-2">MaKrab KAMPUS SUCI</h3>
                <p class="text-black py-1 px-2 rounded font-b\">Dari IDR 249K</p>
                  <b class="bg-red-500 text-white py-1 px-2 rounded-full">Diskon s/d 50%</b>
          </nuxt-link>
        </div>
        <br />
        ...
        <div
          ...
          <nuxt-link to="/event" class="event-card flex-none w-60">
            <img src="/img/e.jpg" alt="MaKrab KAMPUS SUCI" class="rounded-lg" />
            <h3 class="text-lg mt-2 px-2">MaKrab KAMPUS SUCI</h3>
            <b class="text-black py-1 px-2 rounded">Dari IDR 249K</b>
          </nuxt-link>
        </div>
      </section>
    </main>
