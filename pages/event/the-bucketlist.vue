    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <nuxt-link to="/jakarta" class="hover:underline">Indonesia</nuxt-link> &gt; 
          <span class="text-blue-900 font-semibold">The Bucketlist</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">The Bucketlist</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">The Bucketlist (PT Samboga kayana)</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>The Bucketlist</b><br>
            Jl. R. H. Moh. Tohir No.1, RT.07/RW.10, Tanah Baru, Kec. Bogor Utara, Kota Bogor, Jawa Barat 16154, Indonesia</p>  
            </div>
        ...
        <span class="text-gray-800 font-bold">Dari IDR 250K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/dd.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
            Kamu si penggemar olahraga basket atau orang yang ingin mencari aktivitas liburan yang anti mainstream? The Bucketlist Indonesia jawabanya!
            <br><br>
            The Bucketlist merupakan destinasi wisata bertemakan bola basket, dengan beragam bintang di dalamnya. …
        </p>
        <!-- Teks lengkap yang ditampilkan jika showMore adalah true -->
        <p class="text-gray-800 mb-4" v-else>
            Kamu si penggemar olahraga basket atau orang yang ingin mencari aktivitas liburan yang anti mainstream? The Bucketlist Indonesia jawabanya!
          <br><br>
          The Bucketlist merupakan destinasi wisata bertemakan bola basket, dengan beragam bintang di dalamnya. Tempat yang punya julukan sebagai “The First and Largest Basketball Gallery in Indonesia“ memiliki koleksi lebih dari 15.000 memorabilia “grail“ (langka atau satu-satunya) dari pebasket nasional maupun internasional. Terdapat pula sepatu, jersey sekaligus cerita-cerita inspiratif di baliknya. Penasaran? Yuk, beli tiket The Bucketlist di Goersapp.com.
          <br>
          Beragam eksperience yang akan didapatkan di The Bucketlist Indonesia:
          <br>
          <ul class="text-gray-800 mb-4">
            <li>- Melihat secara langsung, koleksi memorabilia langka dari para bintang NBA yang dipamerkan di The Bucketlist</li>
            <li>- Merasakan fasilitas bertemakan basket lainnya seperti, lapangan utama, lapangan 1on1, The Bucketlist Kitchen, outlet NCR Spot dan lainnya</li>
            <li>- Bisa berfoto di berbagai spot galeri yang instagramable</li>
        </ul>
        </p>
