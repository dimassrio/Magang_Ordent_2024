    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <nuxt-link to="/jakarta" class="hover:underline">Bandung</nuxt-link> &gt; 
          <span class="text-blue-900 font-semibold">The Papandayan Jazz Fest 2024</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">The Papandayan Jazz Fest 2024</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">The Papandayan Jazz Fest Management</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>The Papandayan Hotel</b><br>
                Jl. Jendral Gatot Subroto no.83, Bandung Kota, Jawa Barat, Indonesia</p>  
            </div>
            ...
            <div class="flex items-center mb-4">
              ...
              <p class="text-gray-800 font-semibold">26 Oct '24 - 27 Oct '24</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 149K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/d.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
            <b>The Papandayan Jazz Fest (TPJF)</b> adalah festival musik jazz tahunan yang diselenggarakan di The papandayan sejak tahun 2015, yang disutradarai oleh The Papandayan & Media Group. Selama 8 tahun terakhir, TPJF telah menyusun pengalaman luar biasa, menyatukan berbagai musisi jazz domestik dan …
        </p>
        <p class="text-gray-800 mb-4" v-else>
            <b>The Papandayan Jazz Fest (TPJF)</b> adalah festival musik jazz tahunan yang diselenggarakan di The papandayan sejak tahun 2015, yang disutradarai oleh The Papandayan & Media Group. Selama 8 tahun terakhir, TPJF telah menyusun pengalaman luar biasa, menyatukan berbagai musisi jazz domestik dan internasional.
            <br><br>
            Dengan lebih dari ratusan musisi menghiasi panggungnya, TPJF telah menjadi platform untuk cerita legendaris dan pertunjukan di enam panggung yang berbeda, meningkatkan apresiasi jazz di negara ini. Festival ini telah menetapkan dirinya sebagai acara penting dalam kalender tur musik tahunan di Bandung, menawarkan tidak hanya jazz tetapi juga blues, funk, soul, pop, dan berbagai genre musik populer lainnya.
            <br><br>
            TPJF tidak hanya sebagai festival musik, tetapi juga terdapat rangkaian-rangkaian program lainnya, seperti: Music Clinic, penghargaan lifetime achievement untuk musisi legendaris serta awarding untuk pemenang TP Jazz International Online Competition, sebagai bentuk komitmen TPJF yang tidak hanya dapat menjadi wadah eksistensi bagi para kreator musik jazz tetapi juga sekaligus mampu melahirkan musisi-musisi jazz yang berkualitas di masa mendatang. 
            <br><br>
            Kemudian program lainnya yaitu Pasar Jazz menjadikan festival ini secara aktif mendukung usaha mikro, kecil dan menengah sementara terlibat dalam kegiatan pendukung lainnya yang berkontribusi nilai-nilai bermanfaat untuk masyarakat yang lebih luas.
        </p>
        <button @click="toggleShowMore" class="text-green-500">
          {{ showMore ? 'Baca Lebih Sedikit' : 'Baca Lebih Banyak' }}
        </button>
      </div>

      <div class="mt-4">
        <h2 class="text-xl font-bold mb-2">Aturan dan Kebijakan</h2>
        <h5 class="font-semibold">Berikut adalah barang barang yang tidak diperbolehkan dibawa dari luar :</h5>
        <p class="text-gray-800 mb-4" v-if="!showMore">
          <ul>
            <li>1. Makanan dan minuman dari luar</li>
            <li>2. Alkohol…</li>
          </ul>
        </p>
        <p class="text-gray-800 mb-4" v-else>
          <ul class="text-gray-800 mb-4">
            ...
            <li>2. Alkohol</li>
            <li>3. Laser pen</li>
            <li>4. Obat obatan terlarang</li>
            <li>5. Hewan peliharaan</li>
            <li>6. Ransel besar</li>
            <li>7. Rokok</li>
            <li>8. Senjata tajam</li>
            <li>9. Selfie stick</li>
            <li>10. Panitia tidak menyediakan tempat ppenitipan barang</li>
        </ul>
        </p>
        <button @click="toggleShowMore" class="text-green-500">
          {{ showMore ? 'Baca Lebih Sedikit' : 'Baca Lebih Banyak' }}
