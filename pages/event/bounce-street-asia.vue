    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <span class="text-blue-900 font-semibold">Bounce Street Asia</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">Dept Live in Jakarta 2024</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">Bounce Street Asia (PT Rekreasi Keluarga Indonesia)</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>Bounce Street Asia - Trampoline Park</b><br>Jl. Sentra Bisnis Artha Gading Blok D Kav. 8, Kelapa Gading, Jakarta Utara, Jakarta, Indonesia</p>  
            </div>
            ...
            <div class="flex items-center mb-4">
              ...
              <p class="text-gray-800"> Lihat jadwal pada tiket untuk mengetahui jam buka</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 20K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/cc.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
            Cari tempat refreshing di Jakarta yang nggak membosankan? Bounce Street Asia jawabannya!
            <br><br>
            Trampoline Park terbaik di Jakarta yang cocok untuk rekreasi, quality time, dan refreshing bersama keluarga …
        </p>
        <!-- Teks lengkap yang ditampilkan jika showMore adalah true -->
        <p class="text-gray-800 mb-4" v-else>
            Cari tempat refreshing di Jakarta yang nggak membosankan? Bounce Street Asia jawabannya!
          <br><br>
          Trampoline Park terbaik di Jakarta yang cocok untuk rekreasi, quality time, dan refreshing bersama keluarga atau sahabat. Terdapat banyak aktivitas mengasyikkan melawan gravitasi yang patut dicoba. Mulai dari berlari menaiki tembok, melompat-lompat seru, slam dunking, atau mencoba beberapa manuver gerakan terbang.
          <br><br>
          Rasakan serunya 11 wahana bermain lainnya di Bounce Street Asia yang nggak kalah seru, seperti Kids Court, Court, Aero, Basketball, Airbag, Wallclimbing, Wallrunner, Dodgeball, Battle bim, Spidertower, dan Foampit.
          <br><br>
          Main di sini juga baik untuk kesehatan, dengan 10 menit melompat di atas trampolin setara dengan berlari selama 30 menit. Tentunya bisa bantu menurunkan stress dan meningkatkan hormon bahagia.
          <br><br>
          Lapar setelah mengeluarkan banyak kalori dari melompat-lompat? Langsung aja k Bounce Cafe yang punya menu sehat dan lezat. Kamu bisa juga ke Mall Artha Gading karena tempatnya ada di belakang mall tersebut.
          <br><br>
          Sangat menarik, bukan? Yuk, makanya segera bersenang-senang sampai puas di Bounce Street Asia!
          <br><br>
          Rasakan pengalaman mendebarkan melompat-lompat di atas trampolin di Bounce Street Asia!
          <br>
          Fasilitas:
          <br>
