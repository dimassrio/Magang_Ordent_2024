    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <nuxt-link to="/bekasi" class="hover:underline">Bekasi</nuxt-link> &gt; 
          <span class="text-blue-900 font-semibold">Puri Nirwana Waterpark Festival</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">Puri Nirwana Waterpark Festival</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">Puri Nirwana Waterpark</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>Puri Nirwana Waterpark</b>, Jl, Ki Hajar Dewantara, Sukaraya, kecamatan Karangbahagia, Bekasi Kabupaten, Jawa Barat, Indonesia</p>  
            </div>
            ...
            <div class="flex items-center mb-4">
              ...
              <p class="text-blue-900 font-semibold">10 Aug '24, 10.00-22.00 WIB</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 50K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/e.jpeg" alt="Dept Live in Jakarta 2024" class="w-3/4 h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
            Nama Event: Waterpark Festival
          <br>
            Tanggal Acara: 10 Agustus 2024
            <br>
            Lokasi: Puri Nirwana Waterpark Cikarang…
        </p>
        ...
        <p class="text-gray-800 mb-4" v-else>
          ...
          <br>
            ...
            Lokasi: Puri Nirwana Waterpark Cikarang
            <br>
            untuk pertama kalinya di BEKASI mengadakan acara festival musik didalam wahana waterpark. Festival musik yang diadakan di puri nirwana waterpark cikarang adalah sebuah acara musik yang diadakan didalam arena waterpark sehingga penoton bisa menikmati acara musik sambil menikmati wahana kolam berenang yang menampilkan musisi-musisi lokal dan nasional . Acara ini bertujuan untuk merayakan keragaman musik indonesia juga memberikan platform bagi band untuk menunjukan bakat mereka serta mempertemukan para pecinta musik. Dengan genre musik yang beragam dari pop, breakbeat, hingga rock alternatif acara ini menawarkan pengalaman musik yang intim dan autentik. selain pertunjukan festival musik, penonton juga bisa menikmati hiburan area waterpark.
        </p>
      ...
      <div class="mt-4">
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
          <ul>
            <li>1. Pastikan data diri sudah sesuai dengan kartu identitas</li>
            <li>2. Tiket akan ditukarkan dengan wristband pada saat hari H acara</li>
            <li>3. Ada batasan umur pengunjung wajib di atas 18+...</li>
          </ul>
        </p>
        <p class="text-gray-800 mb-4" v-else>
          <ul class="text-gray-800 mb-4">
            ...
            <li>2. Tiket akan ditukarkan dengan wristband pada saat hari H acara</li>
            <li>3. Ada batasan umur pengunjung wajib di atas 18+</li>
            <li>4. Pengunjung tidak diperbolehkan membawa senjata tajam dan senjata api.</li>
            <li>5. Pengunjung tidak diperbolehkan membawa obat-obatan terlarang.</li>
            <li>6. Pengunjung tidak diperbolehkan membawa hewan peliharaan.</li>
            <li>7. Pengunjung tidak diperbolehkan membawa makanan dan minuman dari luar</li>
            <li>8. Pengunjung tidak diperbolehkan membawa kamera DSLR.</li>
            <li>9. Pengunjung tidak diperbolehkan membawa bahan yang mudah terbakar.</li>
            <li>10. Pengunjung tidak diperbolehkan membawa Drone.</li>
        </ul>
        </p>
        <button @click="toggleShowMore" class="text-green-500">
          {{ showMore ? 'Baca Lebih Sedikit' : 'Baca Lebih Banyak' }}
