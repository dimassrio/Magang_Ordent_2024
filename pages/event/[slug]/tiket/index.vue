    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <div class="container mx-auto p-4" v-if="event">
        <header class="flex justify-between items-center mb-4">
          ...
          <button class="bg-teal-600 text-white hover:bg-teal-400 py-2 px-4 rounded transition duration-300 ease-in-out transform hover:scale-105 duration-400" @click="showCalendar=true">Pilih Tanggal</button>
        </header>
