    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <nuxt-link to="/Indonesia" class="hover:underline">Jakarta</nuxt-link> &gt; 
          <span class="text-blue-900 font-semibold">Krakatau Park</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">Dept Live in Jakarta 2024</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">Krakatau Park (PT Bunga Lampung Sedjati)</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>Krakatau Park</b><br>
                Kawasan Pelabuhan Penyebrangan, Bakauheni, Kec. Bakuheni, Kabupaten Lampung Selatan, Lampung 35592, Indonesia</p>  
            </div>
            ...
            <div class="flex items-center mb-4">
              ...
              <p class="text-gray-800"> 10.00-20.00 WIB</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 90K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/aa.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
            Lagi cari tempat untuk wisata bersama keluarga yang super lengkap di Lampung?? Ke Krakatau Park jawabannya!…
        </p>
        <!-- Teks lengkap yang ditampilkan jika showMore adalah true -->
        <p class="text-gray-800 mb-4" v-else>
            Lagi cari tempat untuk wisata bersama keluarga yang super lengkap di Lampung?? Ke Krakatau Park jawabannya!
          <br><br>
          Krakatau Park merupakan theme park terbesar dan terlengkap di Lampung, yang memiliki standar keamanan yang ketat. Terdapat berbagai macam wahana permainan yang seru banget untuk dicoba.
          <br><br>
          Explore satu per satu 26 wahana rekreasi menarik yang ada di sini, mulai dari wahana permainan seperti Rainbow Slide, Kuda Terbang, Ayunan Terbang, Mobil Disko, Komedi Putar, Kebun Kumbang, 3D Cinema, Tornado dan masih banyak lainnya.
          <br><br>
          Ada juga wahana untuk wisata edukasi yang cocok untuk anak? Kamu bisa coba wahana Science Center untuk mempelajari beragam permainan interaktif dan juga ada Istana Anak yang bisa dijadikan pilihan untuk wahana edukasi motorik anak.
          <br><br>
          Temukan berbagai macam experience menyenangkan jika liburan di Krakatau Park!
          <br><br>
          Fasilitas:
          <br>
