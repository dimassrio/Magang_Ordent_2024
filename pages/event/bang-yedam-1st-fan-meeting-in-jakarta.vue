    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <span class="text-blue-900 font-semibold">BANG YEDAM 1ST FAN MEETING IN JAKARTA</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">BANG YEDAM 1ST FAN MEETING IN JAKARTA</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">Kolam Ikan Entertainment</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>Jakarta International Velodrome</b><br>
                Jl. Balap Sepeda No.35, Indonesia, Jakarta, Indonesia </p>  
            </div>
            ...
            <div class="flex items-center mb-4">
              ...
              <p class="text-gray-800">03 Aug '24, 19.00-22.00 WIB</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 900K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/c.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4">
            Indonesia BY:D! Bang Yedam bilang dia udah gak sabar ketemu kalian di fanmeeting nihhBang Yedam akan mengadakan fanmeeting pertamanya pada 3 Agustus 2024 di Jakarta International Velodrome. 
        </p>
      </div>
