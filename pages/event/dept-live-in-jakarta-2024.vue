<template>
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          <nuxt-link to="/" class="hover:underline">Beranda</nuxt-link> &gt; 
          <nuxt-link to="/jakarta" class="hover:underline">Jakarta</nuxt-link> &gt; 
          <span class="text-blue-900 font-semibold">Dept Live in Jakarta 2024</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">Dept Live in Jakarta 2024</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">SISTIC</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>Balai Sarbini</b><br>
                Jl. Jend. Sudirman Kav. 50, Karet, Semanggi, Setiabudi, Jakarta Pusat, Jakarta, Indonesia</p>  
            </div>
            <div class="items-center flex flex-col md:flex-row ml-2 mb-4">
                <nuxt-link to="#" class="text-green-700 font-semibold">Lihat di peta</nuxt-link>  
            </div>
            <div class="flex items-center mb-4">
              <i class="fas fa-calendar-alt text-green-500 mr-2"></i>
              <p class="text-gray-800">24 Aug '24, 19.00-21.00 WIB</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 840K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
    </div>
</div>
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/a.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
  
        <div class="mt-8">
        <h2 class="text-xl font-bold mb-2">Tentang experience ini</h2>
        <!-- Teks singkat yang ditampilkan jika showMore adalah false -->
        <p class="text-gray-800 mb-4" v-if="!showMore">
          Prepare for an unforgettable musical experience as South Korean R&B artiste Dept announces upcoming concerts in Jakarta and Singapore! Known for his unique blend of Pop, R&B and Soul, these highly anticipated performances follow Dept's sold-out show in Bangkok, promising to captivate audiences with his diverse ...
        </p>
        <!-- Teks lengkap yang ditampilkan jika showMore adalah true -->
        <p class="text-gray-800 mb-4" v-else>
          Prepare for an unforgettable musical experience as South Korean R&B artiste Dept announces upcoming concerts in Jakarta and Singapore! Known for his unique blend of Pop, R&B and Soul, these highly anticipated performances follow Dept's sold-out show in Bangkok, promising to captivate audiences with his diverse musical repertoire and dynamic stage presence.
          <br><br>
          Dept recently performed a sold-out concert in Bangkok, demonstrating his growing popularity and the strong connection he has with his fans. The success of this concert highlights the anticipation and excitement surrounding his upcoming shows in Jakarta and Singapore.
          <br><br>
          Bursting onto the music scene in July 2016 with his debut single easily, Dept quickly garnered recognition for his eclectic fusion of R&B influences. The moniker Dept cleverly combines the words debt and department, symbolizing his deep gratitude and respect for the artists who have shaped his musical journey.
          <br><br>
          His early work is characterized by the release of albums in the alternative R&B genre in 2017 and 2018, showcasing a blend of various musical styles. In 2019, DEPT expanded his musical horizons by exploring the pop genre, further diversifying his sound and captivating a broader audience.
          <br><br>
          At the heart of Depts music is a commitment to creating a deeply personal and resonant experience for his listeners. His songs address shared experiences and emotions, aiming to touch the hearts of his audience. His collaborations with an consistent art director ensure that his albums not only sound incredible but also present a friendly and cohesively beautiful image.
          <br><br>
          Admission Rules
          <br>
          <ul class="text-gray-800 mb-4">
            <li>-Rating: General</li>
            <li>-No admission for infant in arms and children aged below 6 years old.</li>
            <li>-Children aged 6 and above must purchase a ticket for admission.</li>
            <li>-Admission is subject to tickets produced at entrance</li>
        </ul>
        <br>
        Late Seating Advisory
        <ul class="text-gray-800 mb-4">
            <li>-You are strongly advised to be seated 30 minutes before the performance start time</li>
            <li>-No admission will be allowed into the venue once the performance has commenced</li>
        </ul>
        <br>
        ...
        <!-- Tombol untuk mengubah state showMore -->
        <button @click="toggleShowMore" class="text-green-500 hover:underline">
          {{ showMore ? 'Baca Lebih Sedikit' : 'Baca Lebih Banyak' }}
        </button>
      </div>
  
        <div class="mt-8">
          <h2 class="text-xl font-bold mb-2">Bagikan:</h2>
          <div class="flex space-x-4">
            <a href="" class="text-gray-800"><i class="fab fa-xing"></i></a>
            <a href="" class="text-gray-800"><i class="fab fa-linkedin"></i></a>
            <a href="" class="text-gray-800"><i class="fab fa-whatsapp"></i></a>
            <a href="" class="text-gray-800"><i class="fab fa-telegram"></i></a>
          </div>
        </div>
      </main>
  
      <footer class="bg-gray-100 p-8 border-t border-gray-200 mt-8">
        ...
        <div class="footer-bottom flex flex-col md:flex-row justify-center items-center py-4">
          ...
          <div class="newsletter flex flex-col md:flex-row items-center ml-0 md:ml-8">
            ...
            <input type="email" placeholder="Alamat email" class="p-2 border rounded-lg mr-2">
            <button class="p-2 border rounded-lg bg-teal-200 hover:bg-green-500 transition-colors duration-400 text-white font-bold gap-4">Berlangganan</button>
          </div>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        showMore: false, // State untuk mengontrol tampilan teks
        eventTitle: 'Dept Live in Jakarta 2024'
      };
    },
    methods: {
      toggleShowMore() {
        this.showMore = !this.showMore; // Metode untuk mengubah state showMore
      }
    }
  }
  </script>
