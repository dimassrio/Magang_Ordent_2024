    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <span class="text-blue-900 font-semibold">12AM Indonesia - 360° Theatrical Audio Experience</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">12AM Indonesia - 360° Theatrical Audio Experience</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">12AM Indonesia (PT Andhakar Maya Internasional)</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>The Van der Waals (Jakarta)</b><br>
                Jl. bangka raya No.104, RT.1/RW.12, Pela Mampang, Kec. Mampang Prpt., Kota Jakarta Selatan, Daerah K, Mampang Prapatan, jakarta, Indonesia</p>  
            </div>
            ...
            <div class="flex items-center mb-4">
              ...
              <p class="text-gray-800">24 Aug '24, 19.00-01.00 WIB</p>
            </div>
                <div class="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
        <span class="text-gray-800 font-bold">Dari IDR 119K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/bb.jpg" alt="Dept Live in Jakarta 2024" class="w-40 h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
          12AM Indonesia adalah Pengalaman 360° Audio Teater Pertama di Indonesia.
          <br><br>
          Mengundang Anda dalam perjalanan yang memukau di mana audio mengelilingi Anda dan membawa Anda ke dunia-dunia yang tak terbayangkan. Bersiaplah untuk sebuah perjalanan melintasi alam semesta paralel, di …
        </p>
        <!-- Teks lengkap yang ditampilkan jika showMore adalah true -->
        <p class="text-gray-800 mb-4" v-else>
          12AM Indonesia adalah Pengalaman 360° Audio Teater Pertama di Indonesia.
          <br><br>
          Mengundang Anda dalam perjalanan yang memukau di mana audio mengelilingi Anda dan membawa Anda ke dunia-dunia yang tak terbayangkan. Bersiaplah untuk sebuah perjalanan melintasi alam semesta paralel, di mana kata-kata menenun kisah keajaiban yang memudarkan batas antara realita dan fiksi.
          <br><br>
          Dalam pertunjukan, penonton akan disuguhkan dengan pengalaman magis di mana mereka mengenakan headphone dalam ruangan gelap gulita. Di tengah petualangan, mereka akan memilih alur cerita sendiri, memasuki perjalanan teatrikal yang luar biasa. Sensasi mendalam dan visual yang memukau akan mengantarkan mereka melampaui batas dunia nyata.
          <br><br>
          Seluruh pengalaman ini telah dirancang untuk melibatkan setiap indera penonton, menciptakan sebuah pengalaman yang tak terlupakan.
        </p>
