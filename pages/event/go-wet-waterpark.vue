    ...
    <div class="font-sans bg-white overflow-x-hidden">
      ...
      <main class="p-4">
        <div class="breadcrumb text-sm text-gray-600 mb-4 ml-2">
          ...
          <span class="text-blue-900 font-semibold">Go! Wet Waterpark</span>
        </div>
  
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-2/3">
            <h1 class="text-2xl font-bold mb-2 ml-2">The Bucketlist</h1>
            <p class="text-gray-600 mb-4 ml-2 text-sm">oleh <Nuxt-Link to="#" class="text-green-500 text-sm">Go!Wet Waterpatk (PT Mahaka Visual Indonesia)</Nuxt-Link></p> 
            <div class="flex items-center mb-4">
              <i class="fas fa-map-marker-alt text-green-500 mr-2"></i>
              <p class="text-gray-800"><b>Go! Wet Waterpark</b><br>
            Grand Wisata Bekasi, tambun, Bekasi Kota, jawa Barat, Indonesia</p>  
            </div>
        ...
        <span class="text-gray-800 font-bold">Dari IDR 70K</span>
        <button class="bg-teal-500 text-white font-bold py-2 px-9 rounded-lg hover:bg-teal-600 transition-colors duration-300">Beli Tiket</button>
            ...
            <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                <img src="/img/ee.jpg" alt="Dept Live in Jakarta 2024" class="w-lg h-auto object-cover rounded-lg" />
            </div>
        </div>
        ...
        <p class="text-gray-800 mb-4" v-if="!showMore">
            Sedang cari waterpark seru dan cocok untuk semua umur di Bekasi? Go! Wet Waterpark bisa jadi pilihan yang tepat nih! Beragam wahana unik ada di waterpark ini, seperti Go Splash, Go Boomer, Go Wave dan banyak wahana lainnya, dimana masing-masing wahana cocok untuk kelompok usia tertentu. Wisata bareng …
        </p>
        <!-- Teks lengkap yang ditampilkan jika showMore adalah true -->
        <p class="text-gray-800 mb-4" v-else>
            Sedang cari waterpark seru dan cocok untuk semua umur di Bekasi? Go! Wet Waterpark bisa jadi pilihan yang tepat nih! Beragam wahana unik ada di waterpark ini, seperti Go Splash, Go Boomer, Go Wave dan banyak wahana lainnya, dimana masing-masing wahana cocok untuk kelompok usia tertentu. Wisata bareng
            keluarga? Aman, jika berkunjung ke Go Wet Waterpark Grand Wisata Bekasi.
          <br><br>
          Selain itu kamu dan keluarga juga bisa merasakan sensasi yang memicu adrenalin saat mencoba salah seluncuran ekstrim di Go Wet. Jangan lewatkan keseruan mencoba slide berbentuk python pertama di Indonesia, rasakan sensasi meluncur dari ketinggian 16 m dengan kemiringan hingga 90 derajat. Segera beli tiketnya dan ajak keluargamu menikmati keseruan bermain air di sini!
          <br><br>
          Beragam eksperience yang akan kamu dapatkan bersama keluarga ataupun teman di Go Wet:
          <br>
          <ul class="text-gray-800 mb-4">
            <li>- Nikmati keseruan bermain air di kolam ombak dan 21 wahana seru lainnya</li>
            <li>- Serunya meluncur bersama orang tersayang di wahana Go Flash atau keseruan saat bersantai di Go Lazy</li>
            <li>- Merasakan nikmatnya bermain air di waterpark terbesar di Bekasi</li>
        </ul>
        </p>
